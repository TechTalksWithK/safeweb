...
const AntiGravityCanvas = () => {
  ...
  const initParticles = useCallback((width, height) => {
    ...
    for (let i = 0; i < particleCount; i++) {
      ...
      newParticles.push({
        ...
        color: Math.random() > 0.85 ? LIME_GREEN : '#ffffff',
  ...
  const animate = useCallback((time) => {
    ...
    // Pulsating radial glow using lime green
    ...
    gradient.addColorStop(0, `rgba(57, 255, 20, ${pulseOpacity})`); // Lime green glow
    gradient.addColorStop(0.5, `rgba(13, 34, 68, ${pulseOpacity * 0.5})`); // Navy mid
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-2 right-3 pointer-events-none text-[10px] text-black/20 font-mono text-right">
