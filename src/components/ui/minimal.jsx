        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="max-w-4xl">
            ...
            <motion.h1
              ...
              style={{ fontFamily: 'Inter, sans-serif', color: '#000000', letterSpacing: '-0.04em' }}
            >
            ...
            <motion.p
              ...
              style={{ fontFamily: 'Inter, sans-serif', color: '#555555', lineHeight: '1.6', maxWidth: '700px' }}
            >
              {description}
            </motion.p>
            ...
            >
              {primaryButton && (
                <motion.button
                  ...
                  style={{ background: accentColor, color: '#000000', fontFamily: 'Inter, sans-serif' }}
                >
                  {primaryButton.label}
                </motion.button>
              )}
